...
namespace OsosOracle.MvcUI.Controllers
{
    ...
    public class ReportController : BaseController
    {
        ...
        public JsonResult SatisRaporu(RaporParametreModel model)
        {
            ...
            con.ConnectionString = ConnectionString;
            con.Open();
            string sql = @"SELECT NESNEDEGER.AD AS SATISTIPI, CSTSAYACMODEL.AD AS SAYACMODEL,ENTSAYAC.KAPAKSERINO,ENTABONE.ABONENO,ENTABONE.AD,ENTABONE.SOYAD, ENTSATIS.OLUSTURMATARIH,ENTSATIS.KREDI,ENTSATIS.KDV,ENTSATIS.CTV,ENTSATIS.AYLIKBAKIMBEDELI,ENTSATIS.ODEME FROM ENTSATIS INNER JOIN ENTSAYAC ON ENTSATIS.SAYACKAYITNO=ENTSAYAC.KAYITNO
                       ...
                       INNER JOIN NESNEDEGER ON ENTSATIS.SATISTIPI=NESNEDEGER.KAYITNO
WHERE 1=1 {whr}

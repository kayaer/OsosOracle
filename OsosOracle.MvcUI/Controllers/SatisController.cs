...
namespace OsosOracle.MvcUI.Controllers
{
    ...
    public class SatisController : BaseController
    {
        ...
        public SatisController(IENTSATISService entSatisService, IENTSAYACService entSayacService, IENTABONESAYACService entAboneSayacService, IENTABONEBILGIService entAboneBilgiService, IENTABONEService entAboneService)
        {

...
OrtakAvm.prototype.KartBosalt = function () {
    try {
        ...
        if (kartTip == "Abone Karti" || kartTip == "Abone Kartı" || kartTip == "CBA " || kartTip == "Subscriber Card" || kartTip == "GHA ") {
            if (kartTip == "GHA ") {
                var gaz = new ActiveXObject("SmartCard.Gaz");
                result = gaz.Bosalt();
            } else {
                result = su.AboneBosalt();
            }
...
OrtakAvm.prototype.AboneOku = function () {
        ...
        try {
            ...
            if (sessionInformation.Dil == "1") { ajaxMesajGoster(ex, 'Error'); }

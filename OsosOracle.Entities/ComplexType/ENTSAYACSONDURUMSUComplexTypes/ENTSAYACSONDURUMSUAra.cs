...
{
    public class ENTSAYACSONDURUMSUAra
    {
        ...
        public bool ArizaCheck { get; set; }

        public bool AsiriTuketimCheck { get; set; }

        public bool Ceza1Check { get; set; }
        public bool Ceza2Check { get; set; }
        public bool Ceza3Check { get; set; }
        public bool Ceza4Check { get; set; }

        public bool MagnetCheck { get; set; }

        public bool PulseHataCheck { get; set; }

        public bool RtcHataCheck { get; set; }
        public bool MaxDebiCheck { get; set; }
        public bool VanaCheck { get; set; }
        public bool AnaPilBittiCheck { get; set; }

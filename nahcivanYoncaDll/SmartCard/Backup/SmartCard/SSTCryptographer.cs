    ...
    public class SSTCryptographer
    {
        ...
        public static string Decrypt(string strEncrypted, string strKey)
        {
            try
            {
                ...
                temp = objDESCrypto.CreateDecryptor().TransformFinalBlock(byteBuff, 0, byteBuff.Length);
                string strDecrypted = ASCIIEncoding.ASCII.GetString(temp, 0, temp.Length);
                objDESCrypto = null;

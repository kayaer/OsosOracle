...
namespace SmartCard
{
    public class Kart : IKart
    {
        ...
        public string AboneOku()
        {
            ...
            str += devNo + "_" + elkAna + "_" + ako + "_" + yko + "_" + yeniKart + "_" + elkKalan + "_" + elkHarcanan + "_" + elkTarih + "_" +
                   KlemensCeza + "_" + Ariza + "_" + PilZayif + "_" + PilBitik + "_" + k1Tuk + "_" + k2Tuk + "_" + k3Tuk + "_" + gerTuk + "_" +
                   elkEkim + "_" + elkAralik + "_" + kad1 + "_" + kad2 + "_" + kad3 + "_" + lim1 + "_" + lim2 + "_" + loadLim + "_" + aksam + "_" +
                   sabah + "_" + kademe + "_" + hSonuAksam + "_" + fixCharge + "_" + totalFixCharge;

            ClosePort();
            return "1_" + str;
        }

        public string KrediYaz(UInt32 devNo, UInt32 AnaKredi, ITarife trf)
        {
            byte[] issue_area = GetIssuer(zone);
            int i = 0;
            ...
            Hexcon.UInt32toByte4(20000, outBuf);
            i = UpdateCard(0X34);
            if (i == 5) return "5";
            else if (i == 0) return "0";
        ...
        public string AboneYap(UInt32 devNo, ITarife trf)
        {
            byte[] issue_area = GetIssuer(zone);
            int i = 0;
        ...
        public string Cless_YetkiAc(uint devNo, byte KontrolDegeri)
        {

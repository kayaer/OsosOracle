...
namespace SmartCard
{
    ...
    public class Mercan : ISmartCard, IAcr128, IUretim, IYetki
    {
        #region Degiskenler
        public SCResMgr mng;
        public SCReader rd;
            ...
            byte Bayram1Gunn, byte Bayram1Ayy, byte Bayram1Suree, byte Bayram2Gunn, byte Bayram2Ayy, byte Bayram2Suree, byte AvansOnayi, byte IleriSaat, byte YanginModuSuresi, byte MaxDebiSiniri, UInt32 KritikKredi)
        {
            ...
            #region iade Kartı Kontrol-Kredi kontrol
            Abone abo = new Abone(ReadBinary(0, 255));
        ...
        //public string AboneYap(AboneInfo abone)
        //{
        //    #region fiyat,limit,çap kontrol

        //    if (abone.Fiyat1 <= 0 || abone.Fiyat2 <= 0 || abone.Fiyat3 <= 0 || abone.Fiyat4 <= 0 || abone.Fiyat5 <= 0)
        //    {
        //        FinishKart();
        //        return HataSet(25);
        //    }
        //    if (abone.Limit1 <= 0 || abone.Limit2 <= 0 || abone.Limit3 <= 0 || abone.Limit4 <= 0)
        //    {
        //        FinishKart();
        //        return HataSet(26);
        //    }
        ...
        //    else
        //    {
        //        if (abone.Cap == 15 || abone.Cap == 20 || abone.Cap == 25 || abone.Cap == 40 || abone.Cap == 50 || abone.Cap == 65 || abone.Cap == 80 || abone.Cap == 100 || abone.Cap == 125 || abone.Cap == 150 || abone.Cap == 200 || abone.Cap == 250)
        //        {
        //        }
        //        else
        //        {
        ...
        //    Integer4Byte CihazNoo = new Integer4Byte(abone.CihazNo);
        //    byte[] Gonderilecek = { CihazNoo.bir, CihazNoo.iki, CihazNoo.uc, CihazNoo.dort,
        //                            Convert.ToByte(CihazNoo.bir^0x0F), Convert.ToByte(CihazNoo.iki^0x0F),
        //                            Convert.ToByte(CihazNoo.uc^0x0F), Convert.ToByte(CihazNoo.dort^0x0F) };

        //    Status = UpdateIssuer(GlobalAyarlar.GetInstance().Issuer + "A ", abone.CihazNo);
        //    if (!Status)
        //    {
        //        FinishKart();
        //        return HataSet(10);
        ...
        //        case 20:
        //            Integer4Byte Katsayi1 = new Integer4Byte(Convert.ToUInt32(1000));
        //            Integer4Byte Katsayi2 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat2 * 1000 / abone.Fiyat1));
        //            Integer4Byte Katsayi3 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat3 * 1000 / abone.Fiyat1));
        //            Integer4Byte Katsayi4 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat4 * 1000 / abone.Fiyat1));
        //            Integer4Byte Katsayi5 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat5 * 1000 / abone.Fiyat1));
        //            KademeKatsayi1 = Katsayi1.value;
        //            KademeKatsayi2 = Katsayi2.value;
        //            KademeKatsayi3 = Katsayi3.value;
        //            KademeKatsayi4 = Katsayi4.value;
        ...
        //        case 250:
        //            Integer4Byte Katsayi_1 = new Integer4Byte(Convert.ToUInt32(10000));
        //            Integer4Byte Katsayi_2 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat2 * 10000 / abone.Fiyat1));
        //            Integer4Byte Katsayi_3 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat3 * 10000 / abone.Fiyat1));
        //            Integer4Byte Katsayi_4 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat4 * 10000 / abone.Fiyat1));
        //            Integer4Byte Katsayi_5 = new Integer4Byte(Convert.ToUInt32(abone.Fiyat5 * 10000 / abone.Fiyat1));
        //            KademeKatsayi1 = Katsayi_1.value;
        //            KademeKatsayi2 = Katsayi_2.value;
        //            KademeKatsayi3 = Katsayi_3.value;
        //            KademeKatsayi4 = Katsayi_4.value;
        ...
        //    Bayram1 = abone.Bayram1Sure;
        //    Bayram1 <<= 5;
        //    Bayram1 |= abone.Bayram1Gun;
        //    Bayram1 <<= 4;
        //    Bayram1 |= abone.Bayram1Ay;

        //    Bayram2 = abone.Bayram2Sure;
        //    Bayram2 <<= 5;
        //    Bayram2 |= abone.Bayram2Gun;
        //    Bayram2 <<= 4;
        //    Bayram2 |= abone.Bayram2Ay;

        //    abone.KartNo = Convert.ToByte((abone.KartNo & 0x0F) + 0x40);

        //    YazilacakDuzenle0023(abone.CihazNo, KademeKatsayi1, KademeKatsayi2, KademeKatsayi3, abone.Limit1, abone.Limit2);
        //    Status = UpdateBinary(0, Yazilacak);
        //    if (!Status)
        //    {
        //        FinishKart();
        ...
        //    if (abone.IleriSaat == 1) abone.IleriSaat = 0;
        //    else if (abone.IleriSaat == 0) abone.IleriSaat = 0X90;

        //    YazilacakDuzenle2447(0, abone.KritikKredi, 0xC0, 0, abone.KartNo, abone.Cap, abone.Tip, abone.Donem, 25, 30, 0, abone.MaxDebi, abone.AvansOnay, abone.AboneNo, abone.IleriSaat);
        //    Status = UpdateBinary(24, Yazilacak);
        //    if (!Status)
        //    {
        //        FinishKart();
        ...
        //    YazilacakDuzenle5271(KademeKatsayi4, KademeKatsayi5, abone.Limit3, abone.Limit4, 0);
        //    Status = UpdateBinary(52, Yazilacak);
        //    if (!Status)
        //    {
        //        FinishKart();
        ...
        //    Status = SelectFile(EFDataName1);
        //    UpdateBinary(241, new byte[] { abone.YanginModSure }); ////Status = UpdateBinaryOzel(241, YanginModuSuresi);//
        //    if (!Status)
        //    {
        //        FinishKart();
        //        return HataSet(14);
        ...
        //    Status = SelectFile(EFDataName2);
        //    Status = UpdateBinary(72, new byte[] { abone.BaglantiPeriyot });
        //    if (!Status)
        //    {
        //        FinishKart();
        //        return HataSet(14);
        ...
        //public string AboneYaz(AboneInfo abone)
        //{
        //    #region fiyat,limit,çap kontrol
        ...
        //        return HataSet(29);
        //    }
        //    if (abone.CihazNo != Issuer.CihazNo)
        //    {
        //        FinishKart();
        //        return HataSet(12);
        //    }
        ...
        //    {
        //        abone.AnaKredi = abone.AnaKredi + Adres024051.AnaKredi;
        //    }
        //    else
        //    {
        //        Adres000048.unique0 = Convert.ToUInt16(Adres000048.unique0 + 1);
        ...
        //    YazilacakDuzenle2447(abone.AnaKredi, abone.KritikKredi, abone.Ako0, Degerler.IslemNo, Degerler.KartNo, abone.Cap, Degerler.Tip, abone.Donem, 25, 30, 0, abone.MaxDebi, abone.AvansOnay, Degerler.AboneNo, abone.IleriSaat);
        //    Status = UpdateBinary(24, Yazilacak);
        //    if (!Status)
        //    {
        //        FinishKart();
        ...
        //    YazilacakDuzenle5271(KademeKatsayi4, KademeKatsayi5, abone.Limit3, abone.Limit4, Adres072095.KalanKredi);
        //    Status = UpdateBinary(52, Yazilacak);
        //    if (!Status)
        //    {
        //        FinishKart();
